...
BLACK =         (  0,   0,   0)
WHITE =         (255, 255, 255)
BRIGHTBLUE =    (   255, 215, 0)
DARKTURQUOISE = (100,149,237)
GREEN =         (  255,140,  0)
...
def main():
    ...
    pygame.display.set_caption('TTT | Projecto')
    BASICFONT = pygame.font.Font('freesansbold.ttf', BASICFONTSIZE)
    NEW_SURF, NEW_RECT = makeText(' Computer', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 60)
    NEW_SURF2, NEW_RECT2 = makeText(' Human', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 240, WINDOWHEIGHT - 60)
    board = [BLANK] * 9
    game_over = False
    x_turn = True
    msg = "TTT | Projecto - Tic Tac Toe"
    drawBoard(board, msg)
